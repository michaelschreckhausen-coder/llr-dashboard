-- 20260630100300_get_sponsoring_dashboard_org_name.sql
-- Sponsor = Unternehmen (1:1-Extension), Phase 4: top_partners-Name aus public.organizations
-- joinen (statt sponsor_profiles.name, das in 1b gedroppt wird). Sonst identisch.
-- PRE+POST-1b-kompatibel (referenziert sp2.name NICHT mehr).
...
begin
  ...
  -- top_partners: Name aus organizations (1:1-Extension)
