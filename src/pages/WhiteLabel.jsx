  ...
  return (
    <div style={{ maxWidth:780, display:'flex', flexDirection:'column', gap:0 }}>
      ...
      <div style={card}>
        ...
        <div style={{ display:'flex', alignItems:'center', gap:16, padding:'14px 18px', background:wl.sidebar_bg||'#fff', borderRadius:10, border:'1px solid var(--border)', width:'fit-content' }}>
          {wl.logo_url
            ...
            : <div style={{ width:36, height:36, borderRadius:8, background:wl.primary_color||'var(--wl-primary, #0A6FB0)', display:'flex', alignItems:'center', justifyContent:'center' }}>
          ...
          <div>
            <div style={{ fontSize:15, fontWeight:800, color:wl.primary_color||'var(--wl-primary, #0A6FB0)', letterSpacing:'-0.01em' }}>{wl.app_name||'Leadesk'}</div>
      ...
      <div style={card}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:16 }}>
          {[
            ['primary_color',   'Primärfarbe',        'Buttons, NavLinks, aktive Elemente', 'var(--wl-primary, #0A6FB0)'],
            ['secondary_color', 'Sekundärfarbe',       'Erfolg-Badges, KPIs',               '#10B981'],
            ['accent_color',    'Akzentfarbe',         'KI-Features, Highlights',            '#0A6FB0'],
      ...
      {selTenant && (
        <div style={{ ...card, background:'var(--surface-muted)', border:'1px solid var(--border)' }}>
          ...
          <div style={{ fontSize:12, color:'var(--text-muted)', lineHeight:1.8 }}>
            <div>Subdomain: <code style={{ background:'#EAF6FC', color:'var(--wl-primary, #0A6FB0)', padding:'2px 6px', borderRadius:4 }}>
