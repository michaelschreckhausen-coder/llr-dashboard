// ════════════════════════════════════════════════════════════════════════════
// ARCHIV — Legacy-Dashboard mit Widget-Grid + Edit-Modus
// ════════════════════════════════════════════════════════════════════════════
//
// Diese Datei ist die KOMPLETTE alte Dashboard.jsx (Stand vor 2026-05-29).
// Sie enthält das Widget-Grid-System (23 Widgets im CATALOG) + Edit-Modus
// mit Drag&Drop + Layout-Persistence in der dashboard_widgets-Tabelle.
//
// Aktuell NICHT in Router eingebunden — preserved für die geplante
// Cockpit-Surface (eigener Sprint, siehe CLAUDE.md). Bei Re-Use:
//   - Import-Pfade prüfen (relative paths sind 1 Level tiefer als bisher)
//   - Pipeline-Berechnung von leads.deal_* auf deals-Tabelle umstellen
//     (CLAUDE.md Top-Fallstrick #15)
//   - Activity-Feed auf lead_activity_feed-View statt activities-Tabelle
//   - SSI conditional rendern (kein 61 falls keine Daten — siehe CLAUDE.md)
//
// Dashboard.jsx selbst rendert seit 2026-05-29 nur noch die Tagesreise.
// ════════════════════════════════════════════════════════════════════════════
