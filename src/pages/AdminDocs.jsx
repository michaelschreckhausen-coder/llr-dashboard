...
const PAGES = [
  { route:'/',                  file:'pages/Dashboard.jsx',      desc:'Startseite — KPIs, Pipeline-Übersicht, SSI Score, Hot Leads, Aktivitäts-Feed' },
  ...
  { route:'/vernetzungen',      file:'pages/Vernetzungen.jsx',   desc:'LinkedIn-Vernetzungsmanagement — Status, KI-Nachrichten, Aktivitäten' },
...
const ENUMS = [
  ...
  { name:'user_role',            values:['admin','team_member','user'] },
...
export default function AdminDocs() {
  ...
  const TABLES_META = [
    ...
    { name:'changelog',          rows:21,  rls:true,  cols:10,  desc:'Admin Changelog & Logs — Features, Bugfixes' },
