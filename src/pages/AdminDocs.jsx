...
export default function AdminDocs() {
  ...
  const TABLES_META = [
    ...
    { name:'pm_attachments',     rows:0,   rls:true,  cols:8,   desc:'Dateianhänge pro Task — URL, Dateiname, Typ, Größe (Supabase Storage)' },
    ...
    { name:'changelog',          rows:31,  rls:true,  cols:10,  desc:'Admin Changelog & Logs — Features, Bugfixes (v2.1.0: 10 neue Einträge)' },
