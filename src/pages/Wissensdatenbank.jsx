  ...
  return (
    <div style={{ maxWidth: 640, margin: '60px auto', textAlign: 'center', padding: '0 24px' }}>
      ...
      <div style={{ fontSize: 15, color: 'rgb(110,114,140)', lineHeight: 1.7, marginBottom: 32, maxWidth: 480, margin: '0 auto 32px' }}>
        Speichere dein Wissen über Kunden, Branchen und Produkte zentral —
        und lass die KI daraus personalisierte Nachrichten und Inhalte generieren.
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, maxWidth: 480, margin: '0 auto', textAlign: 'left' }}>
        {[
          { icon: '🗂️', title: 'Artikel & Dokumente', desc: 'FAQs, Produktinfos und Prozesse strukturiert ablegen' },
          { icon: '🔍', title: 'KI-Suche', desc: 'Inhalte per Volltextsuche und semantischer Suche finden' },
          { icon: '🤖', title: 'KI-Nutzung', desc: 'Wissen automatisch in Nachrichten und Posts einbinden' },
          { icon: '🔗', title: 'Lead-Verknüpfung', desc: 'Artikel direkt mit Leads und Zielgruppen verbinden' },
        ].map(f => (
