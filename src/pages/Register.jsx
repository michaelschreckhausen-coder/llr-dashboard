...
// Trial-Dauer in Tagen — MUSS mit der echten Backend-Trial-Länge übereinstimmen:
// plans.trial_days des Default-Trial-Plans (is_default_trial=true), das handle_new_user()
// als trial_ends_at = now() + trial_days ansetzt. Aktuell 3 (Migration 20260605170000).
// Alle Trial-Copy dieser Seite läuft über diese eine Konstante, damit sie nie wieder driftet.
const TRIAL_DAYS = 3
      ...
      <div style={{ ...formSideStyle, gridColumn: '1 / -1' }} data-auth-form-side="true">
        <div style={{ ...formInnerStyle, maxWidth: 480, textAlign: 'center' }}>
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontWeight: 700, marginBottom: 2 }}>Dein {TRIAL_DAYS}-Tage-Trial ist aktiv</div>
      ...
      <div style={formSideStyle} data-auth-form-side="true">
        <div style={formInnerStyle}>
          ...
          <p style={subheadStyle}>
            {TRIAL_DAYS} Tage kostenlos testen — keine Kreditkarte nötig.
          </p>
      ...
      <div style={brandSideStyle} data-auth-brand-side="true">
        <div style={brandInnerStyle}>
          ...
          <div style={{
            ...
            {TRIAL_DAYS} Tage kostenlos · ohne Kreditkarte
          </div>

          <ul style={brandBulletsStyle}>
            {[
              { t: 'Voller Funktionsumfang', d: 'Alle Module während des Trials freigeschaltet' },
              { t: 'Keine automatische Verlängerung', d: `Endet automatisch nach ${TRIAL_DAYS} Tagen — kein Risiko` },
