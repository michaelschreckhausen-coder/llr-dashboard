...
export default function BrandVoice({ session, brandType = 'personal' }) {
  ...
  async function disconnectLinkedIn() {
    ...
    try {
      // Server-seitig: Unipile-Account per API loeschen + alle drei Speicher raeumen
      // (unipile_accounts, la_accounts, brand_voices-Marker) + OAuth-Token revoken.
              ...
              <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start' }}>
                <div style={{ flex:1 }}>
                  <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:4 }}>
                    ...
                    {v.tonality && Object.keys(v.tonality).length > 0 && <span style={{ fontSize:10, background:'var(--tint-cyan, #EAF8FE)', color:'#0A6FB0', padding:'2px 8px', borderRadius:10, fontWeight:600 }}>100% vollständig</span>}
                  </div>
