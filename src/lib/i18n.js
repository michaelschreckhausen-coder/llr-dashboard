...
export const TRANSLATIONS = {
  de: {
    ...
    settings_ui_lang:'Dashboard-Sprache',settings_ui_lang_label:'Sprache der Benutzeroberfläche',settings_ui_hint:'Ändert die Sprache des gesamten Dashboards. Wirkt sofort.',
  ...
  en: {
    ...
    settings_ui_lang:'Dashboard language',settings_ui_lang_label:'User interface language',settings_ui_hint:'Changes the language of the entire dashboard. Takes effect immediately.',
