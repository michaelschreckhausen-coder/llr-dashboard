...
### Phase 6 — 🔴 SCHARFSCHALTEN: `gates_enforced=true` (separater, letzter Schritt)
...
Phase 6  admin_set_gate(true)      🔴 SCHARF — separater letzter Flip, beobachtet
...
| 6 scharf | `admin_set_gate(false,…)` (Kill-Switch) | ✅ Flag, <1s |
...
- **Kein** Scharfschalten (Phase 6), solange STOP-Gate α nicht 9/9 grün war.
